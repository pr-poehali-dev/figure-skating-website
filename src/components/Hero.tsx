...
const Hero = () => {
  return (
    <section
      id="home"
      className="pt-16 min-h-screen bg-gradient-to-br from-pastel-pink via-pastel-blue to-winter-blue flex items-center relative overflow-hidden"
    >
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-winter-purple/30 to-winter-pink/30 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-winter-mint/40 to-winter-blue/40 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-br from-winter-peach/20 to-winter-lavender/20 rounded-full blur-2xl"></div>
